...
function getWidthOrHeight(elem, name, extra) {
    ...
    const /** @type {?} */ isBorderBox = false; // jQuery.support.boxSizing && jQuery.css( elem, 'boxSizing', false, styles ) === 'border-box';
